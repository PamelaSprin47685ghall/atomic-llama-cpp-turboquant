...
void process_shaders() {
    ...
    for (auto src : {std::pair{"f32", "float"}, std::pair{"f16", "float16_t"}}) {
        for (std::string dst : {"f32", "f16", "bf16", "q1_0", "q2_0", "pq2_0", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl"}) {
    ...
    string_to_spv("qwen4_gdn_multistep_prep", "qwen4_gdn_multistep_prep.comp", {});
    string_to_spv("qwen4_gdn_multistep_norm", "qwen4_gdn_multistep_norm.comp", {});
    ...
    string_to_spv("argmax_stage1_f32", "argmax_stage1.comp", merge_maps(base_dict, {{"A_TYPE", "float"}}));
    string_to_spv("argmax_stage2_f32", "argmax_stage2.comp", merge_maps(base_dict, {{"A_TYPE", "float"}, {"D_TYPE", "int"}}));
