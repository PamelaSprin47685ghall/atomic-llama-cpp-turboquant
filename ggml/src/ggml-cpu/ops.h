...
void ggml_compute_forward_rerot_span_expand(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_rerot_q_prep(const struct ggml_compute_params * params, struct ggml_tensor * dst);
