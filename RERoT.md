...
**遗留未闭合。** ① 目标机（5×RX 6800 / Ornith-1.5-35B）阶段 5/6/8 未按 `a35ec96f6` 重跑；② wire 回滚后真机 probe 质量（780M + `K=q8_0/V=turbo4`）已有 5/5 HTTP 200 与环拒绝证据，但那是 AGENTS.md 交接记录，本文只引用不重复记账；③ `缺口.md` 的 17 项缺口清单未随本轮核对更新。
